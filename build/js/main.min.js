...
},{"./modules/audio":3,"./modules/breakpoints":4,"./modules/burger-menu":5,"./modules/form-validate/form":7,"./modules/init-js":14,"./modules/init-sliders":15,"./modules/modals/init-modals":16,"./modules/video":21,"./utils/ios-vh-fix":24}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.advantagesSlider = void 0;
// let desktop = window.matchMedia('(max-width: 1199px)');

// if (desktop.matches) {
var advantagesSlider = exports.advantagesSlider = function advantagesSlider() {
...
var menuButtonElement = document.querySelector('.header__navigation-toggle');
var menuButtonImage = menuButtonElement.querySelector('svg');
var menuButtonUseElement = menuButtonImage.querySelector('use');
var headerElement = document.querySelector('.header__wrapper');
var menuNavigationElement = headerElement.querySelector('.header__navigation');
...
var setmenuButtonImage = function setmenuButtonImage() {
...
var _advantagesSlider = require("./advantages-slider");
var initSliders = exports.initSliders = function initSliders() {
  ...
  (0, _advantagesSlider.advantagesSlider)();
};

},{"./advantages-slider":2,"./hero-slider":13,"./reviews-slider":18,"./tours-slider":19,"./trainers-slider":20}],16:[function(require,module,exports){
"use strict";
